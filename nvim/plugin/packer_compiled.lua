...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/ash/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["ranger.vim"] = {
    loaded = true,
    path = "/home/ash/.local/share/nvim/site/pack/packer/start/ranger.vim",
    url = "https://github.com/francoisabrol/ranger.vim"
  },
  ["vim-commentary"] = {
    loaded = true,
